...
const DetailPage = {
    ...
    renderDetail() {
        ...
        // 剧集信息
        document.querySelector('#detail-info-category span').textContent = MockData.categories.find(c => c.id === drama.category)?.name || drama.category;
        document.querySelector('#detail-info-year span').textContent = drama.year;
        document.querySelector('#detail-info-episodes span').textContent = drama.episodes;
        document.querySelector('#detail-info-seasons span').textContent = drama.seasons;
        document.querySelector('#detail-info-rating span').textContent = `★ ${drama.rating}`;
